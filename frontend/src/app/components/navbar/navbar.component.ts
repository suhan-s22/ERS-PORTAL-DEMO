      ...
      <div class="navbar-right">
        ...
        <div class="profile-wrapper">
          <button type="button" class="avatar-btn" (click)="toggleProfileDropdown()" aria-label="Profile menu">
            <img src="https://ui-avatars.com/api/?name=Suhan+S&background=2a52be&color=fff&size=64" alt="Profile" class="avatar-img" />
          </button>

          @if (profileDropdownOpen) {
            <div class="profile-dropdown">
              <div class="profile-picture-wrapper">
                <img src="https://ui-avatars.com/api/?name=Suhan S&background=2a52be&color=fff&size=128" alt="Suhan S" class="profile-picture" />
